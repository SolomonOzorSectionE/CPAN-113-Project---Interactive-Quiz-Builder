...
### Website Purpose
An interactive quiz builder website where users can create quiz questions, attempt them, and view results. Designed for students to test knowledge and create practice quizzes.

**Key Capabilities:**
- Create custom quiz questions with multiple answer options
...
[![Watch the video](https://img.youtube.com/vi/eW-RxWj7Vm0/0.jpg)](https://www.youtube.com/watch?v=eW-RxWj7Vm0)
